...
package io.pivotal.petclinic.service;
...
public class ClinicServiceTests {
    ...
    public void shouldFindOwnersByLastName() {
        Collection<Owner> owners = this.owners.findByLastNameOrderByLastName("Davis");
        assertThat(owners).hasSize(2);

        owners = this.owners.findByLastNameOrderByLastName("Daviss");
...
//        Collection<Owner> owners = this.owners.findByLastNameOrderByLastName("Schultz");
...
//
//        owners = this.owners.findByLastNameOrderByLastName("Schultz");
