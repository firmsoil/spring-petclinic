...
class VisitController {
    ...
    public VisitController(VisitRepository visitRepository, PetRepository petRepository, OwnerRepository ownerRepository) {
    ...
    public Visit loadPetWithVisit(@PathVariable("petId") String petId, Map<String, Object> model) {
        ...
        DisplayPet displayPet = new DisplayPet(pet);
        model.put("pet", displayPet);
        Owner dOwner = this.ownerRepository.findById(displayPet.getOwnerId()).get();
        model.put("owner", new DisplayOwner(dOwner));
